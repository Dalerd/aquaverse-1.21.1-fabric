...
public class ModItems {
    ...
    // Lazy item reference
    public static Item DUNKLEOSTEUS_SPAWN_EGG;

    public static void registerModItems() {
        AquaVerse.LOGGER.info("Registering ModItems for " + AquaVerse.MOD_ID);

        DUNKLEOSTEUS_SPAWN_EGG = registerItem(
                "dunkleosteus_spawn_egg",
